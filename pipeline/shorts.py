...
# ролик вжжены и субтитры (type.SUB_LONG_Y = 0.87), и они при crop+scale
# в 9:16 сохраняют свою долю по высоте — то есть лезут в кадр шортса
# поверх его собственных субтитров. То же самое раньше случалось с
# плашками на числах: на 0.74 субтитр наезжал на плашку прямо в кадре,
# поймано на готовом шортсе ff-ep06, где «Under the treasure trove law
# that» легло поверх «1996». Карточка на числе с тех пор уехала в верхнюю
# треть (editorial/textcard.CARD_Y), а низ остался за субтитрами.
#
