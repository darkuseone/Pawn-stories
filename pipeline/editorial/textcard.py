...
# Цвет суммы. ЕДИНСТВЕННЫЙ акцентный цвет в кадре: субтитр работает двумя
# ступенями яркости одного белого (type.SUB_FULL / SUB_DIM_A), и янтарь
# достаётся только сумме находки — тому, ради чего ролик и смотрят. Пока
# подсветка субтитра тоже была янтарной, акцент не был акцентом.
AMBER_RGB = "0xFFC440"
